...
public class ContactosPanelBeanInfo extends SimpleBeanInfo {
    ...
    private static final int METHOD_getScrollableBlockIncrement57 = 57;
    private static final int METHOD_getScrollableUnitIncrement58 = 58;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_addPropertyChangeListener8] = new MethodDescriptor(agendascc.UI.ContactosPanel.class.getMethod("addPropertyChangeListener", new Class[] {java.lang.String.class, java.beans.PropertyChangeListener.class})); // NOI18N
            ...
            methods[METHOD_getScrollableBlockIncrement57] = new MethodDescriptor(org.jdesktop.swingx.JXPanel.class.getMethod("getScrollableBlockIncrement", new Class[] {java.awt.Rectangle.class, int.class, int.class})); // NOI18N
            methods[METHOD_getScrollableBlockIncrement57].setDisplayName ( "" );
            methods[METHOD_getScrollableUnitIncrement58] = new MethodDescriptor(org.jdesktop.swingx.JXPanel.class.getMethod("getScrollableUnitIncrement", new Class[] {java.awt.Rectangle.class, int.class, int.class})); // NOI18N
            methods[METHOD_getScrollableUnitIncrement58].setDisplayName ( "" );
            ...
            methods[METHOD_removePropertyChangeListener114] = new MethodDescriptor(agendascc.UI.ContactosPanel.class.getMethod("removePropertyChangeListener", new Class[] {java.lang.String.class, java.beans.PropertyChangeListener.class})); // NOI18N
